...
import {STEP_ITEMS} from './forms'
import { from } from 'rxjs';
@Component({
  selector: 'app-multiple-forms-module',
  templateUrl: './multiple-forms-module.component.html',
  styleUrls: ['./multiple-forms-module.component.scss']
})
export class MultipleFormsModuleComponent implements OnInit {

  @Input() formContent = STEP_ITEMS;
